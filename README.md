...
- 修复本场禁言参数，支持本场、2 小时、4 小时、24 小时、7 天和永久禁言；
- 禁言成功后显示自动消失的结果提示，禁言名单展示操作管理员；
- 用户向上滚动审阅历史弹幕时暂停自动跟随，并通过“查看最新弹幕”恢复实时滚动；
- 实时弹幕缓存上限提升至 1000 条；
- 醒目留言调整为单行横向滚动，并按价格从高到低排列；
- 修复弹幕时间戳显示错乱及多条醒目留言导致的布局问题。
